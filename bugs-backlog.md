...
4. Briefs now include `## 8. NEXT AD SCRIPTS` with exactly three complete variation scripts, each rendered with a Strategy Snapshot table plus a timed Script Breakdown table.
