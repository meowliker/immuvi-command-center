    ...
    def _execute_producer_run(self, prod_run: dict) -> None:
        ...
        try:
            ...
            _prompt = (
                ...
                "11. Preserve reference anatomy, not just theme. Reference anatomy wins over offer/CTA prominence when they conflict. If the reference has a human subject, include a comparable visible human subject in similar scale/role/pose region; do not replace them with a backpack, chair, desk, hallway, worksheet, empty classroom, playground, or product shot. For BREAKING NEWS references, use only three sections: photo + thin red/blue BREAKING NEWS band + one compact white headline strip. No green/red CTA bar, product mockup, oversized poster headline, large white copy block, icon/product row, or separate FREE TODAY button. If the offer cannot fit inside the same 1-2 line white headline strip, omit the offer.\n"
