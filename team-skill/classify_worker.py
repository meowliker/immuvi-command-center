    ...
    def _execute_producer_run(self, prod_run: dict) -> None:
        ...
        try:
            ...
            _prompt = (
                ...
                "7. Build a reference_anatomy note before generation: subject_type, subject_presence, setting, composition, overlay_system, copy_density, and product_presence.\n"
                ...
                "11. Preserve reference anatomy, not just theme. Reference anatomy wins over offer/CTA prominence when they conflict. If the reference has a human subject, include a comparable visible human subject in similar scale/role/pose region; do not replace them with a backpack, chair, desk, hallway, worksheet, empty classroom, playground, or product shot. For BREAKING NEWS references, make one full-bleed candid photo with compact overlays on top of the photo: a left-anchored red/blue slanted BREAKING NEWS band around the lower third, about 50-65% canvas width and 7-10% canvas height, plus one compact left-anchored white headline strip directly below, about 75-90% canvas width and 8-12% canvas height. Keep visible photo under and around the overlays. No full-width TV-news bar, green/red CTA bar, blank white bottom panel, product mockup, oversized poster headline, large white copy block, icon/product row, or separate FREE TODAY button. If the offer cannot fit inside the same 1-2 line white headline strip, omit the offer.\n"
                ...
                "13. Quality gate each image before upload — persona match, readable typography, reference-anatomy match, mechanic match, brand fit, not generic. For BREAKING NEWS references, reject any image with no comparable visible human subject when the reference has one, a full-width TV-news banner, a separate CTA/footer/button, a blank white bottom panel, a bottom poster block, oversized headline text, photo missing below/around the overlays, or more than three visual elements instead of photo + compact left-anchored news band + one compact left-anchored white headline strip.\n"
                ...
                "inspiration_dimensions, aspect_ratio, reference_anatomy, prompt, image_model, quality_gate. "
