...
class Worker:
    ...
    def run_skill_on_job(self, job: dict) -> dict:
        ...
        prompt = (
            ...
            f"  1. Resolve product context from Supabase products: name plus products.config, including clickup_list_id, doc_id, ins_prefix, and config.production.offer when present.\n"
    ...
    def run_variation_brief_skill_on_job(self, job, ctx):
        ...
        prompt = (
            ...
            f"                                    Time | Label | Caption / Voice Over | What Happens | Emotion Triggered)\n"
