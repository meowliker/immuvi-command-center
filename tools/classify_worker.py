    ...
    def _execute_producer_run(self, prod_run: dict) -> None:
        ...
        try:
            ...
            _prompt = (
                ...
                "10. Generate the requested number of standalone image files using your native image generation at high quality (same as Codex chat — do not hard-code a specific model name). Never count a merged grid/contact sheet as a final output.\n"
                ...
                "12. Quality gate each image before upload — persona match, offer/benefit clarity, readable typography, reference-anatomy match, mechanic match, brand fit, not generic.\n"
                "13. Regenerate once if quality gate fails.\n"
                "14. Upload final images to ClickUp.\n"
                "15. Add ClickUp comment with summary and output links.\n"
                "16. Set ClickUp task status to Ready to Launch only after upload succeeds.\n"
                "17. PATCH producer_runs row "
