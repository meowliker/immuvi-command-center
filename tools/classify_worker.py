...
class Worker:
    ...
    def run_skill_on_job(self, job: dict) -> dict:
        ...
        prompt = (
            ...
            f"     Plus: body_copy, creative_hypothesis, duration_seconds (best-effort), and voice_over.\n"
            f"     voice_over is MANDATORY: transcript spoken narration if present; otherwise exactly 'No voice over'.\n"
            f"  5. Build the 7-section creative brief markdown. In the SNAPSHOT section, include "
            f"a dedicated 'Voice Over' line with the transcript or 'No voice over'.\n"
            ...
            f"creativeHypothesis, duration_seconds, mediaKind, voiceOver, _clickupDocPageUrl, _clickupDocId, classifiedAt, "
            f"formatName, notes.\n"
            f"\n"
            ...
            f"    data->>'voiceOver'         non-empty (use exactly 'No voice over' if no narration)\n"
